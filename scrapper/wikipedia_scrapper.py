...
def scrap(url:str):
    ...
    if pagina.status_code != 200:
        raise Exception(f'Error al obtener la pagina: {pagina.status_code}en la pagina {url}')
    return pagina
...
if __name__ == '__main__': 
    ...
    parser.add_argument('--url', type=str, help = 'URL de la pafina de Wkikipedia')
